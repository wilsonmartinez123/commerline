...
if (!empty($request->newImage)) {
    ...
    $sql = "UPDATE productos SET nombre_pro = '$newName', precioNuevo_pro ='$newPrice', descripcion_pro ='$newDescription', imagen_pro ='$images', precioAnterior_pro  ='$newOfferprice', diasOferta_pro ='$newDiasoferta', inicioOferta_pro ='$newFechainicio', finOferta_pro ='$newFechafin', id_categoria ='$id_categoria', id_subcategoria ='$id_subcategoria'   WHERE id_pro ='$idProducto';";
