...
while ($row = mysqli_fetch_array($result)) {
    ...
    $query2 = "SELECT DISTINCT s.nombre_subcategoria, s.id_categoria FROM subcategorias s INNER JOIN productos p ON p.id_subcategoria = s.id_subcategoria  WHERE s.id_categoria='$id'";
