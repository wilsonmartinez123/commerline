...
public class jsoup {
    ...
    public void getPageLinks(String URL) {
        if (!links.contains(URL)) {
            try {
                ...
                Elements otherLinks = document.select("a[href^=\"https://www.exito.com/Tecnologia-Celulares_y_accesorios-Smartphones/_/N-2b5t\"]");
    ...
    public void getArticles() {
        links.forEach(x -> {
            ...
            try {
                ...
                //Elements articleLinks = document.select("h1.name a[href^=\"https://www.exito.com/\"]");
               Elements articleLinks = document.select("h1.name");
    ...
    public static void main(String[] args) {
        jsoup bwc = new jsoup();
        bwc.getPageLinks("https://www.exito.com/");
        bwc.getArticles();
