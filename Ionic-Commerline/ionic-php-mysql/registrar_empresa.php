...
if ($result = mysqli_query($con, $sql)) {
    if ($row = $result->fetch_assoc()) {
        ...
        $sql = "INSERT INTO empresa (id_cliente, nombre_emp, direccion_emp, municipio_emp, departamento_emp, horario_emp, logo_emp, link_emp, telefono_emp) VALUES ('$id_cliente',' $name','$direccion', '$municipio', '$departamento', '$horario',  '$image', '$paginaWeb', '$numero_contacto')";
